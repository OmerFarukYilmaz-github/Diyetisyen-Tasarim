...
{
    class YesilliklerDunyasiDiyeti : IDiyetAta
    {
        ...
        {
            return YesilliklerDunyasiDiyetiAta(kullaniciID);
        }
        private bool YesilliklerDunyasiDiyetiAta(string kullaniciID)
        {
            baglanti.Open();
            ...
            komut.Parameters.AddWithValue("@DiyetID", "4");
